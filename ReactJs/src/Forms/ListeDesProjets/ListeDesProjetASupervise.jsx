...
import classes from "./ListeProjets";
import Swal from "sweetalert2";
import { useNavigate } from "react-router-dom";
import DetailsProjet from "../DetailsProjet/DetailsProjet";
import * as XLSX from "xlsx";
function ListeDesProjetASupervise() {
  ...
  useEffect(() => {
    console.log(userId);
    axios
      .get(`${base_url}/project/invite/${userId}`)
      .then((response) => {
        console.log("slouma", response);
  ...
  const generateExcelFile = () => {
    ...
    const data = listeProjets.map((projet) => {
      ...
      //   .map((collaborateur) => `${collaborateur._id} `)
      //   .join(", ");
      return [
        projet.name,
        projet.domaine,
              ...
              <div className="col-12 mb-4 mb-sm-5">
                <div className="d-sm-flex justify-content-between align-items-center">
                  <h1 className="h3 mb-3 mb-sm-0 d-sm-flex justify-content-between align-items-center">
                    ...
                    Liste des Projets sous ma supervision
                  </h1>
                          ...
                          {USER_ROLE && USER_ROLE === "internautes" && (
                            <>
                              <Button
                                ...
                                danger
                                onClick={() =>
                                  navigate("/internaute/editProject", {
                                    state: {
                                      project: projet,
                                    },
                                  })
...
export default ListeDesProjetASupervise;
