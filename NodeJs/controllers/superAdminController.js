...
module.exports = {
  ...
  updateEthereumAddress: async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            message: "SuperAdmin Ethereum address updated successfully",
            data: superAdmin
        });
    } catch (error) {
        console.error("Error updating Ethereum address superAdmin:", error);
        res.status(500).json({
            success: false,
            message: "Error updating Ethereum address superAdmin: " + error.message,
            data: null
        });
    }
  },
  updateEthereumPrivateKey: async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            message: "SuperAdmin ethereumPrivateKey updated successfully",
            data: superAdmin
        });
    } catch (error) {
        console.error("Error updating ethereumPrivateKey superAdmin:", error);
        res.status(500).json({
            success: false,
            message: "Error updating ethereumPrivateKey superAdmin: " + error.message,
            data: null
        });
    }
  },
