...
module.exports = {
  ...
  updateEthereumAddress: async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Patient Ethereum address updated successfully",
            data: patient
        });
    } catch (error) {
        console.error("Error updating Ethereum address patient:", error);
        res.status(500).json({
            success: false,
            message: "Error updating Ethereum address patient: " + error.message,
            data: null
        });
    }
  },
  updateEthereumPrivateKey: async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Patient ethereumPrivateKey updated successfully",
            data: patient
        });
    } catch (error) {
        console.error("Error updating ethereumPrivateKey patient:", error);
        res.status(500).json({
            success: false,
            message: "Error updating ethereumPrivateKey patient: " + error.message,
            data: null
        });
    }
  },
